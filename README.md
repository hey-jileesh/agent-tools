...
| [`prd`](prd/SKILL.md) | Interactive requirement analyst — turns a fuzzy idea, feature request, or **Jira epic/story** (read via `jira-issue-reader`) into a precise, business-level **PRD** using Rich Hickey's "Design in Practice" (Socratic questioning, decision matrices, phased design). |
