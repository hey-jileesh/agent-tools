...
# The full set agent-enablement can produce. Only files that actually exist are
# staged, so running a subset of skills just commits fewer files.
DOC_FILES = ["architecture.md", "AGENT.md", "PROJECT_SUMMARY.md",
             "SCA.html", "REPO_ACTIVITY.html"]
COMMIT_MSG = (
    "docs: add agent-enablement artifacts\n\n"
    "Generated by the agent-enablement skills on the feature/agent-enablement branch."
)
